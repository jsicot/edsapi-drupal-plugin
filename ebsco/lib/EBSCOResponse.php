  ...
  */
  private function buildRecords()
  {
    ...
    foreach ($records as $record) {
      ...
      if (isset($record->FullText->Text->Availability)){
      ...
      if (isset($record->FullTextHoldings)) {
        ...
        foreach ($record->FullTextHoldings->FullTextHolding as $FullTextHolding) {
          if (isset($FullTextHolding)){
            $result['FullTextHoldings'][] = (array) $FullTextHolding ;
          }
        }
      }
      ...
      if(isset($record->RecordInfo)){
        ...
        if(isset($record->RecordInfo->BibRecord->BibEntity->Identifiers)){
        ...
        if(isset($record->RecordInfo->BibRecord->BibEntity->Languages)){
        ...
        if(isset($record->RecordInfo->BibRecord->BibEntity->PhysicalDescription)){
        ...
        if(isset($record->RecordInfo->BibRecord->BibEntity->Subjects)){
        ...
        if(isset($record->RecordInfo->BibRecord->BibEntity->Titles)){
        ...
        if(isset($record->RecordInfo->BibRecord->BibRelationships->IsPartOfRelationships->IsPartOf)){
          foreach($record->RecordInfo->BibRecord->BibRelationships->IsPartOfRelationships->IsPartOf as $relationship){
            if(isset($relationship->BibEntity->Dates)){
            ...
            if(isset($relationship->BibEntity->Identifiers)){
            ...
            if(isset($relationship->BibEntity->Numbering)){
