...
<?php if ($records): ?>
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title"><strong><?php print $record_start; ?></strong> - <strong><?php print $record_end; ?></strong>
        <?php print t('of'); ?> <strong><?php print $record_count; ?></strong> <?php print t('results')?>
        <small> <?php if ($search_view == 'basic'): ?>
